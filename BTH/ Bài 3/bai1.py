...
plt.plot(x_vals, y_vals, label=r'$y = x^3 + 10 \cos^2(x)$', color='b')
plt.plot(x_vals, dy_vals, label=r"$y' = 3x^2 - 20\cos(x)\sin(x)$", color='r', linestyle='--')
